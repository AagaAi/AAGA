...
# ============================================================
# Keep-alive: self-ping every 10 min → Render free tier won't sleep
# ============================================================
RENDER_URL = os.environ.get("RENDER_URL", "https://aaga.onrender.com")
...
@app.get("/health")
def health():
    """UptimeRobot ping endpoint — always returns 200 OK"""
